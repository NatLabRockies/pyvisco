...
a possible violation, please email the project maintainer at
**martin.springer@nlr.gov**. Reports will be handled confidentially.
...
4. **Permanent Ban**
   ...
   2. Consequence: Access to all community spaces, tools, and communication
      ...
      to if working through other remedies has failed to change the behavior.
